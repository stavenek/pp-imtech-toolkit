...
const WS = {
  ...
  textModules: {
    alpha: {
      ...
      whyState: 'Snabb och tydlig kommunikation är grunden för att teamet ska kunna leverera med kvalitet och i tid. Utan det tappar vi kunder och medarbetare.',
    ...
    beta: {
      ...
      whyState: 'Långsamma releaser och regressionsbuggar kostar oss tid och kundförtroende. Automatisering är nyckeln till att kunna leverera snabbt utan att tumma på kvaliteten.',
    ...
    gamma: {
      ...
      whyState: 'Leveransproblem driver kunder till konkurrenter. Pålitlig logistik är en förutsättning för tillväxt och kundlojalitet.',
    ...
    stod: {
      ...
      whyState: 'Utan tydlig intern support spiller alla tid på att leta rätt information. Det påverkar produktiviteten i hela organisationen.',
    ...
    utv: {
      ...
      whyState: 'Teknisk skuld och manuella processer bromsar oss. Utan modernisering kan vi inte konkurrera om utvecklartalang eller leverera i den takt verksamheten kräver.',
    ...
    support: {
      ...
      whyState: 'Nöjda kunder stannar och rekommenderar oss. Snabb och professionell support är avgörande för vår tillväxt och vårt rykte.',
